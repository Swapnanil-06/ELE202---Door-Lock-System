...
class Keypad
{
   ...
   //declare object "debouncer" so "counter" and "last_signal" is stored and will not be destroyed across multiple scans
   //allow keypad.cpp uses the functions in debounce.cpp
   Debounce debouncer;


   // class definitions for the rows (inputs) and columns (outputs)
